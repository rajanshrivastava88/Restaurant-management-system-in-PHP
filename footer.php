		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">Greater Kailash-1, New Delhi, Pin - 110048</p>
					<p class="lead"><a href="#">+91 987 6543 219</a></p>
					<p><a href="#">myresturant.info@gmail.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
