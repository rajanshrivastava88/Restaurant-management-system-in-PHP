			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<p class="m-b-40">Maher Kathiyawadi Restaurant is serving a Authentic Kathiyawadi Food.And
							Restaurant's
							<br>
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12 text-center">
				<div class="inner-column">
					...
					<h4>Little Story</h4>
					<p>Restaurants in Ahmedabad, Ahmedabad Restaurants, Bopal restaurants, Best Bopal restaurants, West
						Ahmedabad restaurants, Gujarati Restaurants in Ahmedabad, Gujarati near me, Gujarati Restaurants
						in West Ahmedabad, Gujarati Restaurants in Bopal.
					</p>
					<p>
						Quick Bites in Ahmedabad, Quick Bites near me, Quick Bites in West Ahmedabad, Quick Bites in
						Bopal,
						in Ahmedabad, near me, in West Ahmedabad, in Bopal, in Ahmedabad, near me, in West Ahmedabad,
						in Bopal, New Year Parties in Ahmedabad, Christmas' Special in Ahmedabad.
					</p>
			...
			<div class="col-3">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab"
						aria-controls="v-pills-profile" aria-selected="false">KathiyaWadi</a>
					<a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab"
						aria-controls="v-pills-messages" aria-selected="false">RajsThani</< /a>
						<a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings"
							role="tab" aria-controls="v-pills-settings" aria-selected="false">Rise</a>
						<a class="nav-link" id="v-pills-tava-tab" data-toggle="pill" href="#v-pills-tava" role="tab"
							aria-controls="v-pills-tava" aria-selected="false">tava</a>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="heading-title text-center">
					...
					<p>"if you build a greater experience, customer tell each other about that, word of mouth is very
						powerful"</p>
				</div>
			</div>
		</div>
